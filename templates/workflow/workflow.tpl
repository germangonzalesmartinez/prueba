...
{block name="page"}
	...
	<tabs default-tab="workflow" :track-history="true">
		<tab id="workflow" label="{translate key="manager.workflow"}">
			...
			>
				<pkp-form v-bind="components.{PKP\components\forms\decision\SelectRevisionDecisionForm::FORM_SELECT_REVISION_DECISION}" @set="set" @success="goToRevisionDecision" />
			</modal>
			...
			>
				<pkp-form v-bind="components.{PKP\components\forms\decision\SelectRevisionRecommendationForm::FORM_SELECT_REVISION_RECOMMENDATION}" @set="set" @success="goToRevisionDecision" />
			</modal>
		</tab>
