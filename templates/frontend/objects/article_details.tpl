...
<article class="obj_article_details">
	...
	{if !$activeTheme->getOption('showMultilingualMetadata') && $publication->getLocalizedData('subtitle')}
		<h2 class="subtitle">
			{$publication->getLocalizedSubTitle(null, 'html')|strip_unsafe_html}
		</h2>
	{elseif isset($pubLocaleData.subtitle.text[$pubLocaleData.titleLocale])}
	...
	<div class="row">
		<div class="main_entry">
			...
			{if !$activeTheme->getOption('showMultilingualMetadata')}
				{* Keywords *}
